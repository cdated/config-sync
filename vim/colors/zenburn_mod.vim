...
"
" * Work-around to a Vim bug, it seems to misinterpret ctermfg and 234 and 233
...
if &t_Co > 255
    ...
    hi DiffAdd         ctermbg=25    cterm=bold
    hi DiffChange      ctermbg=96    cterm=bold
    hi DiffDelete      ctermfg=12    ctermbg=6       cterm=bold
    hi DiffText        ctermbg=124   cterm=bold      cterm=reverse  cterm=bold
    ...
    hi Todo            ctermfg=113   ctermbg=234     cterm=bold
    ...
    hi SpellLocal ctermfg=14  ctermbg=233
    hi SpellBad   ctermfg=9   ctermbg=233
    hi SpellCap   ctermfg=12  ctermbg=233
    hi SpellRare  ctermfg=13  ctermbg=233
...
if exists("g:zenburn_force_dark_Background") && g:zenburn_force_dark_Background
    ...
    " value (234 or 233 above) as a light color, and wrongly sets background to
...
if exists("g:zenburn_high_Contrast") && g:zenburn_high_Contrast
    ...
    if &t_Co > 255
        ...
        hi TabLine       ctermbg=236 ctermfg=113 cterm=none
